...
class FakeMessageService : MessageService {
    ...
    val users: Map<String, UserVM> = mapOf(
        ...
        "RickAndMorty" to UserVM("RickAndMorty", URL("https://cdn.vox-cdn.com/thumbor/RGZcrE3kSl8fO8OqDaShbt8SHNM=/1400x1400/filters:format(png)/cdn.vox-cdn.com/uploads/chorus_asset/file/23988498/PrqCxoNU.png")),
